...
```{r}
slope <- read.delim("./code/Rhea-master/1.Normalization/RarefactionCurve.TAB", sep = "\t", check.names = F)
slope %>% ggplot(mapping = aes(x = slope, y = SampleID)) +
...
Plot the value
Decide on cut-off
remove values from otu rhea tab
